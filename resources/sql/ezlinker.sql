...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '阿里云密钥配置表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ez_device`  (
  ...
  `project_id` int(0) NOT NULL COMMENT '项目',
  `product_id` int(0) NOT NULL COMMENT '产品',
  `protocol` int(0) NULL DEFAULT NULL COMMENT '协议类型',
  ...
  `state` int(0) NULL DEFAULT NULL COMMENT '1:在线;2:离线;3未激活',
  ...
  `is_superuser` int(0) NULL DEFAULT NULL COMMENT '是否超级权限',
...
CREATE TABLE `ez_device_protocol_config`  (
  ...
  `value` int(0) NULL DEFAULT 0 COMMENT '配置值',
  `description` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '描述',
  `record_version` int(0) NOT NULL DEFAULT 0 COMMENT '记录版本',
  `x` tinyint(0) UNSIGNED NOT NULL DEFAULT 0 COMMENT '删除',
  `create_time` datetime(0) NOT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '设备协议配置表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ez_dictionary_value`  (
  `id` int(0) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'PK',
  `key_id` int(0) NULL DEFAULT NULL,
  ...
  `record_version` int(0) NOT NULL DEFAULT 0 COMMENT '记录版本',
  `x` tinyint(0) UNSIGNED NOT NULL DEFAULT 0,
...
-- ----------------------------
INSERT INTO `ez_emqx_config` VALUES (1, 'localhost', 'a4315772bf6dd', 'MjkyMTE2MDIwMjE2MTIwNjk1NzYzMzQ5OTIxNDI0OTk4NDA', 8081, 'emqx@127.0.0.1', 0, '默认本地节点1', 2, 0, '2020-03-06 13:56:13');
INSERT INTO `ez_emqx_config` VALUES (2, 'localhost', '1', '1', 8081, 'node2@127.0.0.1', NULL, '默认本地节点2', 0, 0, '2020-03-06 13:56:13');
...
CREATE TABLE `ez_feature`  (
  `id` int(0) UNSIGNED NOT NULL AUTO_INCREMENT,
  `product_id` int(0) NULL DEFAULT NULL COMMENT '所属产品',
...
CREATE TABLE `ez_module`  (
  `id` int(0) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'PK',
  `device_id` int(0) NULL DEFAULT NULL COMMENT '绑定的设备',
  `type` int(0) NULL DEFAULT NULL COMMENT '模块类型',
  `name` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '名称',
  ...
  `create_time` datetime(0) NOT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '设备上面的模块，和设备是多对一关系' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ez_module_template`  (
  ...
  `create_time` datetime(0) NOT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '产品上面的模块模板' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of ez_module_template
-- ----------------------------
INSERT INTO `ez_module_template` VALUES (1, 1, 'BUTTON', 'shot', 'https://s2.ax1x.com/2020/03/03/3fzUMT.png', '[{\"type\": 1, \"field\": \"cmd\", \"description\": \"按钮事件\", \"defaultValue\": \"0\"}]', '开炮啊', 0, 0, '2020-03-24 21:30:46');
INSERT INTO `ez_module_template` VALUES (2, 1, 'SWITCH', 'swtich', 'https://s2.ax1x.com/2020/03/03/3fz0Z4.th.png', '[{\"type\": 3, \"field\": \"state\", \"description\": \"开关状态\", \"defaultValue\": \"false\"}]', '开关', 0, 0, '2020-03-31 22:52:26');
INSERT INTO `ez_module_template` VALUES (3, 1, 'DATA_ENTITY', '数据急', NULL, '[{\"type\": 1, \"field\": \"数值\", \"description\": \"1\", \"defaultValue\": \"0\"}, {\"type\": 2, \"field\": \"备注\", \"description\": \"2\", \"defaultValue\": \"default\"}]', '数据啊', 0, 0, '2020-04-05 14:28:49');
...
CREATE TABLE `ez_module_type_config`  (
  `id` int(0) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'PK',
  `type` int(0) NULL DEFAULT 0 COMMENT '类型，1：控件，2：视图',
  `label` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '标签',
  `icon` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '图标',
  `name` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '名称',
  `description` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '描述',
  ...
  `create_time` datetime(0) NOT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '模块类型配置表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ez_mqtt_topic`  (
  `id` int(0) UNSIGNED NOT NULL AUTO_INCREMENT,
  `device_id` int(0) NULL DEFAULT NULL COMMENT '设备',
  `client_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'MQTT客户端ID',
  `allow` int(0) NULL DEFAULT 1 COMMENT '是否允许连接: 0=拒绝1=允许',
  `type` tinyint(0) NULL DEFAULT 0 COMMENT '类型 1：S2C；2：C2S；3：STATUS；4：GROUP',
  `access` int(0) NULL DEFAULT 1 COMMENT '行为类型: 1=订阅2=发布3=订阅+发布',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'MQTT的TOPIC记录' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ez_permission`  (
  `id` int(0) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'PK',
  `sort` int(0) UNSIGNED NULL DEFAULT 0 COMMENT '排序值',
  `type` int(0) NOT NULL COMMENT '类型：1目录，2动作',
  `visible` tinyint(0) UNSIGNED NULL DEFAULT 0 COMMENT '是否显示在UI上',
  ...
  `parent` int(0) NOT NULL COMMENT '父资源，如果是0则为顶级',
...
CREATE TABLE `ez_product`  (
  ...
  `type` varchar(4) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '类型',
  `state` int(0) NULL DEFAULT NULL COMMENT '当0设备的时候,状态为:设计中;当已经有设备以后,状态为:生产中,此时不可更改关键数据.',
...
CREATE TABLE `ez_relation_device_module`  (
  `id` int(0) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'pk',
  `device_id` int(0) NOT NULL COMMENT '设备',
  `module_id` int(0) NOT NULL COMMENT ' 模块',
  `record_version` int(0) NOT NULL DEFAULT 0,
...
CREATE TABLE `ez_relation_feature_module`  (
  `id` int(0) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'pk',
  `feature_id` int(0) NOT NULL COMMENT '功能',
  `module_id` int(0) NOT NULL COMMENT ' 模块',
  `record_version` int(0) NOT NULL DEFAULT 0,
  `x` tinyint(1) UNSIGNED ZEROFILL NOT NULL,
  `create_time` datetime(0) NULL DEFAULT NULL,
...
CREATE TABLE `ez_relation_module_visual_style`  (
  ...
  `visual_style_id` int(0) NOT NULL COMMENT '视觉效果ID',
...
CREATE TABLE `ez_relation_product_module`  (
  `id` int(0) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'pk',
  `product_id` int(0) NOT NULL COMMENT '设备',
  `module_id` int(0) NOT NULL COMMENT ' 模块',
  `record_version` int(0) NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `ez_relation_product_tag` VALUES (4, 4, 4, 0, 0, '2020-02-23 22:21:29');
INSERT INTO `ez_relation_product_tag` VALUES (5, 5, 5, 0, 0, '2020-03-15 17:23:48');
INSERT INTO `ez_relation_product_tag` VALUES (6, 6, 5, 0, 0, '2020-03-15 17:23:48');
INSERT INTO `ez_relation_product_tag` VALUES (7, 7, 1, 0, 0, '2020-03-24 21:29:27');
...
CREATE TABLE `ez_relation_protocol_type_module_type`  (
  `id` int(0) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'pk',
  `protocol_type_id` int(0) NOT NULL COMMENT '协议类型',
  `module_type_id` int(0) NOT NULL COMMENT '模块类型',
  `record_version` int(0) NOT NULL DEFAULT 0,
  `x` tinyint(1) UNSIGNED ZEROFILL NOT NULL,
  `create_time` datetime(0) NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `ez_relation_role_permission`  (
  ...
  `permission_value` int(0) NULL DEFAULT NULL COMMENT '权限值',
  `record_version` int(0) NOT NULL DEFAULT 0 COMMENT '记录版本',
  `x` tinyint(0) UNSIGNED NOT NULL DEFAULT 0,
  `create_time` datetime(0) NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '角色和权限关联表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ez_relation_user_permission`  (
  ...
  `permission_id` int(0) NOT NULL COMMENT '资源路径ID',
  `record_version` int(0) NOT NULL DEFAULT 0,
  `x` tinyint(1) UNSIGNED ZEROFILL NOT NULL,
  `create_time` datetime(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `ez_schedule_info`  (
  `id` int(0) UNSIGNED NOT NULL AUTO_INCREMENT,
  `link_id` int(0) NULL DEFAULT NULL COMMENT '作用方ID',
  ...
  `status` int(0) NULL DEFAULT 1 COMMENT '0:停止,1:暂停:2:启动',
...
CREATE TABLE `ez_schedule_template`  (
  `id` int(0) UNSIGNED NOT NULL AUTO_INCREMENT,
  `product_id` int(0) NULL DEFAULT NULL COMMENT '定时任务作用的产品',
  `task_name` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '任务名称',
  `task_description` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '任务描述',
...
CREATE TABLE `ez_tag`  (
  ...
  `link_id` int(0) NOT NULL COMMENT '作用的对象的ID',
  `x` tinyint(1) NOT NULL DEFAULT 0 COMMENT '删除',
  `record_version` int(0) UNSIGNED NOT NULL DEFAULT 0 COMMENT '版本',
  `create_time` datetime(0) NOT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of ez_tag
-- ----------------------------
INSERT INTO `ez_tag` VALUES (4, 'door', 4, 0, 0, '2020-02-23 22:21:29');
INSERT INTO `ez_tag` VALUES (5, 'NB', 5, 0, 0, '2020-03-15 17:23:48');
INSERT INTO `ez_tag` VALUES (6, '贵', 5, 0, 0, '2020-03-15 17:23:48');
INSERT INTO `ez_tag` VALUES (7, '高科技', 1, 0, 0, '2020-03-24 21:29:26');
...
CREATE TABLE `ez_user`  (
  ...
  `user_type` int(0) NULL DEFAULT NULL COMMENT '用户类型：普通用户【1】，企业用户【2】，VIP用户【3】',
  `status` int(0) NULL DEFAULT NULL COMMENT '账户状态：正常【1】，冻结【2】，过期【3】',
  `user_profile_id` int(0) NOT NULL COMMENT '扩展信息',
  ...
  `x` tinyint(0) UNSIGNED NOT NULL DEFAULT 0 COMMENT '是否删除',
  `record_version` int(0) UNSIGNED NOT NULL COMMENT '记录版本',
  `create_time` datetime(0) NOT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of ez_user
-- ----------------------------
INSERT INTO `ez_user` VALUES (1, 'ezlinker', '5F4DCC3B5AA765D61D8327DEB882CF99', '1', '18059150204', 'ezlinker@ez.com', 'EZLinker官方', 'EZLINKER-Official', 1, 1, 0, '2020-04-06 23:49:13', '211.97.105.7', 0, 209, '2019-11-11 22:23:02');
...
CREATE TABLE `ez_user_profile`  (
  ...
  `x` tinyint(0) UNSIGNED NULL DEFAULT 0,
  `record_version` int(0) NOT NULL DEFAULT 0 COMMENT '记录版本',
  `create_time` datetime(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
